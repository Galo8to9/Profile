...
export async function initialize(opts) {
    ...
    const resolveRoutes = getResolveRoutes(fsChecker, config, opts, renderServer.instance, renderServerOpts, devInstance == null ? void 0 : devInstance.ensureMiddleware);
