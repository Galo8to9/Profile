...
export async function collectBuildTraces({ dir, config, distDir, pageKeys, pageInfos, staticPages, nextBuildSpan, hasSsrAmpPages, buildTraceContext, outputFileTracingRoot }) {
            ...
            for (const [entries, tracedFiles] of [
                ...
                for (const file of entries){
                    ...
                    for (const curFile of curFiles || []){
                        ...
                        if (!isMatch(filePath, "**/next/dist/pages/**/*", {
                            dot: true,
                            contains: true
                        })) {
