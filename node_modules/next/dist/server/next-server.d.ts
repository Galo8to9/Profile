...
import BaseServer, { Options, FindComponentsResult, MiddlewareRoutingItem, RequestContext, NormalizedRouteManifest } from './base-server';
...
export default class NextNodeServer extends BaseServer {
    ...
    protected renderHTML(req: NodeNextRequest, res: NodeNextResponse, pathname: string, query: NextParsedUrlQuery, renderOpts: import('./render').RenderOpts): Promise<RenderResult>;
